...
class PPOTrainer(PPORollout):
    def __init__(
        ...
        super(PPOTrainer, self).__init__(
            ...
            use_self_encoder=use_self_encoder,
            # ratio:
            use_my_ratio = use_my_ratio,
            attn_selet_way = attn_selet_way,
            sequencelevel = sequencelevel,
            ratio_s2aanda2s = ratio_s2aanda2s,
            attn_ratio_weight = attn_ratio_weight,

            seq_expl_len_ratio = seq_expl_len_ratio,
            decoder_depth_ratio = decoder_depth_ratio,
            use_cls_ratio = use_cls_ratio,
            norm_loss_ratio = norm_loss_ratio,
            decoder_num_heads_ratio = decoder_num_heads_ratio,
            bert_lr_ratio = bert_lr_ratio,
            encoder_num_heads_ratio = encoder_num_heads_ratio,
            encoder_depth_ratio = encoder_depth_ratio,

            use_next_obs = use_next_obs,
            const_repalce_ratio = const_repalce_ratio,

            attn_speed_way = attn_speed_way,
            use_mask_ratio=use_mask_ratio,
            seq_mask_value=seq_mask_value,
            feat_mask=feat_mask,
            feat_mask_value=feat_mask_value,
            # mimex:
            seq_expl_len_mimex = seq_expl_len_mimex,
            decoder_depth_mimex = decoder_depth_mimex,
            mask_ratio_mimex = mask_ratio_mimex,
            use_cls_mimex = use_cls_mimex,
            norm_loss_mimex = norm_loss_mimex,
            k_expl_mimex = k_expl_mimex,
            n_mask_mimex = n_mask_mimex,
            bert_lr_mimex = bert_lr_mimex,
            decoder_num_heads_mimex = decoder_num_heads_mimex,
            anneal_k_mimex = anneal_k_mimex,
        )
