...
from torch.nn import Identity, Linear, Dropout, LayerNorm
...
from src.algo.mimex.mvp.ppo.attention_utils import *
from src.algo.mimex.mvp.ppo.flash_pytorch import GAU, FLASH
...
class FLASHAttention(nn.Module):
    def __init__(
        ...
        if gau_or_flash:
            self.attn = GAU( # Attention calculation is performed on the entire sequence, suitable for medium to short sequences.
                dim=dim,
            ...
            self.attn = FLASH( # Grouping computation reduces computational complexity and is more suitable for handling long sequences.
                dim=dim,
                group_size = 4,
                query_key_dim = 8,
                expansion_factor = 2.,
