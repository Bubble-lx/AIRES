...
def process_ppo(env, cfg, cfg_dict, logdir, cptdir):
    ...
    save_latest_video = (is_pixel and cfg.save_latest_video)
    ...
    ppo = PPO(
        ...
        expl_cfg=cfg_dict["expl_cfg"],
        action_noise_cfg=cfg_dict["action_noise_cfg"],
        save_latest_video=save_latest_video,
