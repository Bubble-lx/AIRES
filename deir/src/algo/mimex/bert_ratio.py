...
class BERT_RATIO(nn.Module):
    ...
    def __init__(self, seq_len, feature_dim, embed_dim=128, depth=4,
        ...
        self.use_next_obs = use_next_obs # enter the next state or not
        self.encoder_embed = nn.Linear(feature_dim, embed_dim) # feature_dim is 39200, embed_dim is 128
    ...
    def forward(self, x, seq_act, seq_next_obs, keep_batch=False):
        ...
        # Merge the processed list into tensor
